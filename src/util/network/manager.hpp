...
class NetworkManager
{
  ...
  public:
    ...
    type_signal_path signal_vpn_removed()
    {
        return vpn_removed;
    }

    type_signal_simple signal_nm_start()
    {
        return nm_start;
    }

    type_signal_simple signal_nm_stop()
    {
        return nm_stop;
    }

    type_signal_simple signal_mm_start()
    {
        return mm_start;
    }

    type_signal_simple signal_mm_stop()
    {
        return mm_stop;
    }

    std::shared_ptr<Gio::DBus::Proxy> get_nm_proxy()
    {
        return nm_proxy;
    }
    ...
    std::map<std::string, std::shared_ptr<VpnConfig>> get_all_vpns()
    {
        return all_vpns;
    }

    std::map<std::string, std::shared_ptr<Network>> get_all_devices()
    {
        return all_devices;
    }
