...
void ModemNetwork::find_mm_proxy(std::string dev_id)
{
...
std::string ModemNetwork::strength_string()
{
    if (strength >= 80)
    {
        return "excellent";
...
std::string ModemNetwork::get_name()
{
    if (!mm_proxy)
    {
...
std::string ModemNetwork::get_signal_band()
{
    if (strength == 100)
    {
        return "100";
...
std::string ModemNetwork::get_icon_name()
{
    if (!mm_proxy)
    {
