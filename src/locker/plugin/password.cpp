...
/* PAM password C code... */
int pam_conversation(int num_mesg, const struct pam_message **mesg, struct pam_response **resp, void *appdata_ptr)
{
...
void WayfireLockerPasswordPlugin::submit_user_password(std::string password)
{
  ...
  const struct pam_conv local_conversation = { pam_conversation, this};
