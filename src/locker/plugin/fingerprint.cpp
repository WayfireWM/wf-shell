...
void WayfireLockerFingerprintPlugin::on_bus_acquired(const Glib::RefPtr<Gio::DBus::Connection> & connection, const Glib::ustring & name)
{
...
void WayfireLockerFingerprintPlugin::on_device_acquired(const Glib::RefPtr<Gio::AsyncResult> & result)
{
    ...
    auto reply = device_proxy->call_sync("ListEnrolledFingers", nullptr, Glib::Variant<std::tuple<Glib::ustring>>::create(username));
