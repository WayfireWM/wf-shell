...
class WfLightSysfsControl : public WfLightControl
{
  ...
  public:
    WfLightSysfsControl(WayfireBrightness *parent, std::string _path) : WfLightControl(parent)
    {
        path = _path;
...
class WfLightSysfsDbusSystemdControl : public WfLightSysfsControl
{
  ...
  public:
    WfLightSysfsDbusSystemdControl(WayfireBrightness *parent, std::string _path) : WfLightSysfsControl(parent,
            _path)
    {
        ...
        // the path /sys/class/backlight is constant, so 21
...
void SysfsSurveillor::catch_up_widget(WayfireBrightness *widget)
{
...
void SysfsSurveillor::strip_widget(WayfireBrightness *widget)
{
