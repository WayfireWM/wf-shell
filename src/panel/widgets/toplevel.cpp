...
class WayfireToplevel::impl
{
    ...
    std::map<wl_output*, std::unique_ptr<WayfireToplevelIcon>> icons;
    ...
    void handle_output_enter(wl_output *output)
    {
         ...
         * 1. The panel on the given output simply was closed by the user
         *
        ...
        auto icon = std::unique_ptr<WayfireToplevelIcon>(
            new WayfireToplevelIcon(handle, output));
...
WayfireToplevel::WayfireToplevel(zwlr_foreign_toplevel_handle_v1 *handle)
    :pimpl(new WayfireToplevel::impl(handle)) { }
WayfireToplevel::~WayfireToplevel() = default;

void WayfireToplevel::handle_output_leave(wl_output *output)
{
