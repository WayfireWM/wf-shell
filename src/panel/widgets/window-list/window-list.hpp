...
class WayfireWindowList : public Gtk::Box, public WayfireWidget
{
  ...
  public:
    ...
    /**
     * Set the widget which should always be rendered on top of the other child widgets */
     ...
     * @param ref The widget that x is relative to. ref must be a child widget of this box
     * @return the position x, but relative to the box
     */
    int get_absolute_position(int x, Gtk::Widget& ref);

    /** Find the direct child widget at the given box-relative coordinates, ignoring the top widget if
     * possible, i.e if the top widget and some other widget are at the given coordinates, then the bottom
     * widget will be returned
     *
     * @return The direct child widget or none if it doesn't exist
     */
    Gtk::Widget *get_widget_at(int x);
    /** Find the direct child widget before the given box-relative coordinates, ignoring the top widget if
     * possible, i.e if the top widget and some other widget are at the given coordinates, then the bottom
     * widget will be returned
     *
     * @return The direct child widget or none if it doesn't exist
